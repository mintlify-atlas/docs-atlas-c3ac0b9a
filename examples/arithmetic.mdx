---
title: "Arithmetic Programs in Cantor: Addition, Predecessor, Division"
sidebarTitle: "Arithmetic"
description: "Worked examples of arithmetic programs in the Cantor language, from simple addition using built-ins to division via minimization."
---
